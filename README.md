...
~~~sh
# getting the code
git clone git@github.com:nko4/0x.git && cd ./0x/

# developing
npm install
npm start

# deploying (to http://0x.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@0x.2013.nodeknockout.com
ssh root@0x.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@0x.2013.nodeknockout.com
ssh -i ./id_deploy root@0x.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/0x" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
