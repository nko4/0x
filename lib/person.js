...
Person.prototype.separate = function(people, desiredseparation, separateFromSameType, done) {
    var sum = new vector();
    var count = 0;
    ...
    for (var i = 0; i < people.length; ++i) {
        ...
        var isSameType = (other.getType() === this.getType());

        if ((other.name !== this.name) && (d < desiredseparation) && (isSameType === separateFromSameType) ) {
