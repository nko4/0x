...
function seekDubstep(z, people, influencers, done) {
    return z.getNearest(z.location, influencers, 'dubstep', function(e, nearest) {
        if(nearest) {
            return done(e, z.seek(nearest.location).mult(3)); // dubstep is 3 times as powerful as humans
        } else {
...
function separate(z, people, influencers, done) {
   return z.separate(people, 50, true,  done); 
}
...
Zombie.prototype.getBehaviours = function(people) {
    return [separate, seekHuman, seekDubstep];
};
